...
for F = FuncList
    ...
    for r = 1:run_times
        ...
        if strcmpi(algoMode,'PSO')
            ...
            [bestScore, ~, curve] = DE (nPop, MaxIt, lb, ub, dim_true, fobj);
        end
        baseTimes(r)  = toc(t0);
        ...
        for ib = 1:B
            ...
            for r = 1:run_times
                ...
                if strcmpi(algoMode,'PSO')
                    ...
                    [bestScore, ~, curve] = DE_KLSR (nPop, MaxIt, lb, ub, dim_true, fobj, kopt);
                end
                bestVec(r)  = bestScore;
