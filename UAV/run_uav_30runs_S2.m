...
save('/Users/zhengzikun/Desktop/UAV/uav_30runs_S2.mat', ...
     ...
     'best_pos');   % [ADDED]
writetable(Summary, '/Users/zhengzikun/Desktop/UAV/uav_30runs_S2_summary.csv');
...
title('Scenario S2: overlay of 8 best paths', 'FontName','Times New Roman');
set(gca,'FontName','Times New Roman');
xlim([0 200]); ylim([0 200]); zlim([0 100]);
grid on; box on; view(45,25);

print('-djpeg','-r600','/Users/zhengzikun/Desktop/UAV/uav_S2_overlay_8paths.jpg');
...
title('Scenario S2: overlay of 8 best paths (2D top view)', 'FontName','Times New Roman');
set(gca,'FontName','Times New Roman');
xlabel('x'); ylabel('y');

print('-djpeg','-r600','/Users/zhengzikun/Desktop/UAV/uav_S2_overlay_8paths_2D.jpg');
